...
*The original v1 design record, preserved as written. Implementation deviations from
this spec are logged in [implementation-notes.md](../implementation-notes.md).*
